...
///     <body>
  static public function initialize(array $config = array()) {
    ...
    self::$loader = new Core_ModuleLoader($loader_opts);
  }
///     </body>
///   </method>
...
///     <body>
  static public function loader() { return self::$loader; }
///     </body>
///   </method>
...
///     <body>
  static public function make($class) {
    $args = func_get_args();
    return Core_Types::reflection_for(Core_Types::real_class_name_for($class))->
...
///     <body>
  public function invoke() { return call_user_func_array($this->call, $this->args); }
///     </body>
///   </method>
...
///     <body>
  public function __construct($module) {
    ...
    parent::__construct("Module $this->module not found");
  }
///     </body>
///   </method>
...
///   </details>
class Core_ModuleLoader {

  protected $paths   = array('*' => './lib');
...
///     <body>
  public function __construct(array $paths = array()) {
    if ($paths && count($paths)) $this->paths = $paths;
  }
///     </body>
///   </method>
...
///     <body>
  public function load($module) {
    if (!$this->is_loaded($module)) {
      ...
      $this->load_module_file($file = $this->file_path_for($module));
...
///     </details>
///     <body>
  protected function load_module_file($file) {
...
///     <body>
  static public function ends_with($string, $tail) {
    return ((mb_strlen($string) - mb_strrpos($string, $tail)) == mb_strlen($tail));
  }
///     </body>
///   </method>
...
///     <body>
  static public function is_subclass_of($ancestor, $object) {
    ...
    if (!class_exists($object_class)) return false;
