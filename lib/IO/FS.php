...
///     </args>
///     <body>
  static public function File($path) { return new IO_FS_File($path); }
///     </body>
///   </method>
...
///     </args>
///     <body>
  static public function Dir($path = '.') { return new IO_FS_Dir($path); }
///     </body>
///   </method>
...
///     <body>
  static public function file_object_for($path) {
    return self::exists($path = (string) $path) ?
      (self::is_dir($path) ? new IO_FS_Dir($path) : new IO_FS_File($path)) :
       null;
  }
///     </body>
///   </method>
...
///     <body>
  static public function mkdir($path, $mode = 0755, $recursive = false) {
    return (self::exists((string) $path) || mkdir((string) $path, $mode, $recursive)) ?
      self::Dir($path) : null;
  }
///     </body>
///   </method>
...
///     </details>
///     <body>
  static public function chmod($file, $mode) { return chmod((string)$file, $mode); }
///     </body>
///   </method>
...
///     </details>
///     <body>
  static public function chown($file, $owner) { return chown((string)$file, $owner); }
///     </body>
///   </method>
...
///     <body>
  static public function rm($path) {
    $path = (string) $path;
    return file_exists($path) ? (is_dir($path) ? rmdir($path) : unlink($path)) : true;
  }
///     </body>
///   </method>
...
///     </details>
///     <body>
  static public function make_nested_dir($path, $mode = 0755) {
...
///     </details>
///     <body>
  static public function mv($from, $to) { return rename((string) $from, (string) $to); }
///     </body>
///   </method>
...
///     </details>
///     <body>
  static public function cp($from, $to) { return copy((string) $from, (string) $to); }
///     </body>
///   </method>
...
///     <body>
  public function __get($property) {
    switch ($property) {
      ...
      case 'dir_name':  return @dirname($this->path);
...
///     </details>
///     <body>
  public function __destroy() { $this->close(); }
///     </body>
///   </method>
...
///     </details>
///     <body>
  public function load() { return file_get_contents($this->path); }
///     </body>
///   </method>
...
///     </details>
///     <body>
  public function update($data, $flags = LOCK_EX) {
...
///     </details>
///     <body>
  public function append($data, $flags = LOCK_EX) {
...
///     <body>
  public function move_to($destination) {
    ...
    if (IO_FS::mv($this->path, $destination = $this->fix_destination($destination))) {
...
///     <body>
  public function copy_to($destination) {
    return ($this->stream && $this->stream->id) ?
      null :
      (IO_FS::cp($this->path, $destination = $this->fix_destination($destination)) ?
...
///     <body>
  public function next() { $this->skip_to_next(); }
///     </body>
///   </method>
