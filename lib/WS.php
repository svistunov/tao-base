...
///     </args>
///     <body>
  static public function Environment(WS_Environment $parent = null) { return new WS_Environment($parent); }
///     </body>
///   </method>
...
///     </args>
///     <body>
  public function __construct(WS_Environment $parent = null) { $this->parent = $parent; }
///     </body>
///   </method>
...
///     <body>
  public function run(WS_ServiceInterface $app) {
    $this->adapter->process_response(
      $app->run(
        WS::Environment()->request($this->adapter->make_request())));
    return $this;
  }
///     </body>
///   </method>
