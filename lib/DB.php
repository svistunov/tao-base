...
///     <body>
  public function connect() {
    if (!$this->adapter) $this->adapter = DB_Adapter::instantiate($this->dsn);
    return $this;
  }
///     </body>
///   </method>
...
///     <body>
  public function last_insert_id() { return $this->adapter->last_insert_id(); }
///     </body>
///   </method>
...
///     </args>
///     <body>
  public function quote($value) { return $this->adapter->quote((string) $value); }
///     </body>
///   </method>
...
///     <body>
  public function execute() {
    ...
    if ($this->is_successful = $this->adapter->execute($this->binds)) {
...
///     </args>
///     <body>
  public function fetch_all($prototype = null) {
    switch (true) {
      case $prototype == null:
