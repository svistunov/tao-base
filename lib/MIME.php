...
///   </constants>
  ...
  'application/xml' => array('rdf,wsdl,xpdl,xsl'),
  ...
  'message/rfc822' => array('eml,mht,mhtml,nws'),
  'text/css' => array('css'),
  'text/html' => array('htm,html,shtml,htx,htmlx'),
  'text/plain' => array('bat,c,h,ksh,pl,py,rb,php,txt,dat'),
  'text/rtf' => array('rtf'),
    ...
    return isset(self::$type_objects[$type]) ? self::$type_objects[$type] :
      self::$type_objects[$type] = new MIME_Type(
        ...
        explode(
          ...
          self::$types_definition[$type][2] ? MIME::ENCODING_B64 : null);
  }
///     </body>
///   </method>
