...
///     </args>
///     <body>
  static public function Service(WS_ServiceInterface $application, WS_Auth_AuthModuleInterface $auth_module, $auth_url = '/auth/?url={url}') {
...
///     </args>
///     <body>
  public function __construct(WS_ServiceInterface $application, WS_Auth_AuthModuleInterface $auth_module, $auth_url = '/auth/?url={url}') {
