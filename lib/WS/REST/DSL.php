...
Core::load('DSL', 'WS.REST');

/// <class name="WS.REST.DSL" stereotype="module">
class WS_REST_DSL implements Core_ModuleInterface {
...
///     </args>
///     <body>
  static public function Application(WS_REST_Application $application = null) {
    return new WS_REST_DSL_Application(null, $application);
  }
///     </body>
///   </method>
...
abstract class WS_REST_DSL_Builder extends DSL_Builder {}
/// </class>

/// <class name="WS.REST.DSL.Application" extends="DSL.Builder">
class WS_REST_DSL_Application extends WS_REST_DSL_Builder {
...
///     </args>
///     <body>
  public function __construct(WS_REST_DSL_Application $parent = null, WS_REST_Application $app = null, $class_prefix = '') {
    $this->class_prefix = $class_prefix;
    parent::__construct($parent, $app ? $app : new WS_REST_Application());
  }
///     </body>
///   </method>
...
///     </args>
///     <body>
   public function begin_resource($name, $classname, $path = '') {
      $this->object->resource($name, $r = new WS_REST_Resource($this->class_prefix.$classname, $path));
      return new WS_REST_DSL_Resource($this, $r);
   }
///     </body>
///   </method>
...
class WS_REST_DSL_Resource extends WS_REST_DSL_Builder {
...
///     </args>
///     <body>
  public function __construct(WS_REST_DSL_Builder $parent, WS_REST_Resource $resource, $scope = null) {
...
///     <body>
  public function for_methods($http_mask) {
    ...
    return new WS_REST_DSL_Resource($this, $this->object, $s);
  }
///     </body>
///   </method>
...
///     <body>
  public function get($name = 'index', $formats = null) {
    return $this->method($name, Net_HTTP::GET, null, $formats);
  }
///     </body>
///   </method>
...
///     <body>
  public function get_for($path, $name = '', $formats = null) {
    return $this->method($name, Net_HTTP::GET, $path, $formats);
  }
///     </body>
///   </method>
...
///     <args>
///       <arg name="name" type="string" />
///       <arg name="http_mask" type="int" default="Net_HTTP::GET" />
///       <arg name="path" type="string" default="null" />
///       <arg name="formats" type="string" default="null" />
///     </args>
///     <body>
  public function method($name, $http_mask = Net_HTTP::GET, $path = null, $formats = null) {
    $formats = ($formats === null) ?
      (isset($this->scope->formats) ? $this->scope->formats : array() ) :
      $formats;
    $path = $path === null ? (isset($this->scope->path) ? $this->scope->path : 'index') : $path;
    $name = $name ? $name : $path;
    $http_mask = $http_mask === null ? (isset($this->scope->http_methods) ? $this->scope->http_methods : Net_HTTP::GET) : $http_mask;

    $this->object->method(
      Core::with(
        new WS_REST_Method($name))->
          path($path)->
          http($http_mask)->
