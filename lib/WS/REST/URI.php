...
class WS_REST_URI implements Core_ModuleInterface {
///   <constants>
  const VERSION = '0.2.1';
///   </constants>
...
///     </args>
///     <body>
  static public function Template($template) { return new WS_REST_URI_Template($template); }
///     </body>
///   </method>
...
class WS_REST_URI_MatchResults
...
///     <body>
  public function match($uri) {
    if ($this->regexp && preg_match($this->regexp, $uri, $m)) {
      ...
      return new WS_REST_URI_MatchResults($values, ($l && isset($m[$l])) ? $m[$l] : '');
    }
    return null;
  }
///     </body>
