...
class DB_Adapter implements Core_ModuleInterface {
...
///     <body>
  static public function instantiate(DB_DSN $dsn) {
    if (isset(self::$adapters[$dsn->type])) {
      $module = self::$adapters[$dsn->type];
      Core::load("DB.Adapter.$module");
      $c = "DB_Adapter_{$module}_Connection";
      return new $c($dsn);
    } else
