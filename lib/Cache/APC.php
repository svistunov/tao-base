<?php
/// <module name="Cache.APC" version="0.2.0" maintainer="omelkovitch@techart.ru">
///   <brief>APC (Alternative PHP Cache) кэширование</brief>
///   <class name="Cache.APC" stereotype="module">
///   <implements interface="Core.ModuleInterface" />
///   <depends supplier="Cache.APC.Backend" stereotype="creates" />
class Cache_APC implements Core_ModuleInterface {
...
///   <method name="Backend" returns="Cache.APC.Backend">
///     <brief>Фабричный метод, возвращает объект класса Cache.APC.Backend</brief>
///     <args>
///       <arg name="dsn" type="string" brief="строка подключения, должна содержать 'apc://'" />
///     </args>
///     <body>
  public function Backend($dsn) { return new Cache_APC_Backend($dsn); }
///     </body>
///   </method>
...
/// <class name="Cache.APC.Backend" extends="Cache.Backend">
///   <brief>Класс реализующий APC кэширование</brief>
class Cache_APC_Backend extends Cache_Backend {
...
///       <arg name="timeout" type="int" default="Cache_APC::DEFAULT_TIMEOUT" brief="время в течении которого хранится значение в кэше (сек)" />
///     </args>
///     <body>
  public function __construct($dsn, $timeout = Cache_APC::DEFAULT_TIMEOUT) {
...
///     <body>
  public function set($key, $value, $timeout = null) {
    return apc_store($key, serialize($value), Core::if_null($timeout, $this->timeout));
  }
///     </body>
///   </method>
...
///     </args>
///     <body>
  public function has($key) { return (boolean) apc_fetch($key); }
///     </body>
///   </method>
